  ...
  <div>
    <div class="productContainer">
      <el-row style="margin-bottom:100px;border:none;">
        ...
        <el-col class="explanation"><span>생무입고로 현재 타던 차는 그대로 운행하면서 중고시세의 최대 100%까지 대출가능</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>대상</h3>
        </el-col>
        <el-col :sm="20"><span>2005년식부터 가능,년식 대비 중고시세의 100% 가능<br />
            만 65세 이하,지역:도서지역 제외(제주도가능),무직자 가능</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>접수불가</h3>
        </el-col>
        <el-col :sm="20"><span>자동차년식 9년 이상 (2005년식 이후 가능)<br />
            - 차량시세의 할부 및 압류금 제외 잔존가치 400만원 이하<br />
            - 중고차 시세 500만원 미만<br />
            - 법인차, 리스차 시세대비 90%이상 근저당 설정 / 시세대비 저당과다 / 시세대비 할부금 과다 /<br />
            최근명의이전 (1개월 미만)</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>한도</h3>
        </el-col>
        <el-col :sm="20"><span>~ 4000만원 까지</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>기간</h3>
        </el-col>
        <el-col :sm="20"><span>48개월</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>금리</h3>
      ...
      <el-row class="rowText marginText">
        ...
        <el-col :sm="20"><span>신분증,주민등록원초본,통장사본,자동차등록증,주거래3개월 입출금거래내역</span></el-col>
      </el-row>
      <el-row class="rowText marginText">
        <el-col :sm="4">
          <h3>공동명의<br />
        ...
        <el-col :sm="20"><span>4급 부터 진행가능 / 장애부위에 따른 진행여부 결정 (시각, 청각, 언어장애 진행불가)</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>신용</h3>
        </el-col>
        <el-col :sm="20"><span>개인회생, 신용회복, 파산면책 가능</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>공동명의</h3>
        </el-col>
        <el-col :sm="20"><span>차주 & 공동명의자 서류필</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>지급 방식</h3>
    ...
    <el-dialog title="개인정보 취급 방침" width="80%" :visible.sync="termDialog">
      ...
      <br />
      <p>제1조(개인정보의 처리 목적)</p>
      <p>회사는 개인정보를 다음 각 호의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적 외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.</p>
      <p>가. 대부중개에 관한 목적</p>
      <p>개인 대출 계약과 관련하여 금융거래 관계의 설정 여부의 판단, 대출 계약의 체결, 분쟁 해결, 민원 처리 및 법령상 의무이행 등의 목적으로 개인정보를 처리합니다.</p>
      <p>나. 마케팅 및 광고에 활용</p>
      ...
      <br />
      <p>제2조(처리하는 개인정보의 항목)</p>
      <p>회사는 대출 계약의 체결, 유지, 이행 관리 및 상품서비스의 제공을 위한 필수정보 및 선택정보를 다음 각 호와 같이 수집하고 있습니다.</p>
      <p>가. 개인정보의 항목</p>
      <p>(1) 개인식별정보: 성명, 주소, 성별, 국적, 직업, 연락처 등 대출에 필요한 정보</p>
      <p>(2) 신용거래정보: 대출, 보증, 담보, 현금서비스, 신용카드 등 사용 내역</p>
      <p>나. 수집방법</p>
      <p>(1) 서면양식, 홈페이지, 이메일, 전화/팩스, 경품행사, 제휴사로부터의 제공</p>
      <p>(2) 고객센터를 통한 수집</p>
      <br />
      <p>제3조(개인정보의 처리 및 보유 기간)</p>
      <p>법령에 따른 개인정보 보유, 이용기간 또는 고객으로부터 개인정보를 수집 시에 동의 받은 개인정보 보유, 이용기간 내에서 처리 또는 보유합니다. 법령에 따른 개인정보 보유, 이용 기간은 다음과 같습니다.</p>
      <p>가. 신용정보의 수집/처리 및 이용 등에 관한 기록</p>
      <p>(1) 보존 이유 : 신용정보의 이용 및 보호에 관한 법률</p>
      <p>(2) 보존 기간 : 3년</p>
      <p>나. 소비자의 불만 또는 분쟁처리에 관한 기록</p>
      <p>(1) 보존 이유 : 전자상거래 등에서의 소비자보호에 관한 법률</p>
      <p>(2) 보존 기간 : 3년</p>
      <p>다. 웹 사이트 방문기록</p>
      <p>(1) 보존 이유 : 정보통신망 이용촉진 및 정보보호 등에 관한 법률</p>
      <p>(2) 보존 기간 : 3개월</p>
      <p>라. 표시, 광고에 관한 기록</p>
      <p>(1) 보존 기간 : 전자상거래 등에서의 소비자 보호에 관한 법률</p>
      <p>(2) 보존 기간 : 6개월</p>
      <br />
      <p>제4조(개인정보의 제3자 제공)</p>
      <p>회사는 원칙적으로 고객의 개인정보를 제1조에서 명시한 목적 범위 내에서 처리하며, 고객의 사전 동의 없이는 본래의 범위를 초과하여 처리하거나 제3자에게 제공하지 않습니다. 단, 법률의 규정에 의한 정보 제공과 기타 법령이 허용한 하부 위탁이 가능한 범위 내에서는 고객 또는 제3자의 이익을 부당하게 침해할 우려가 있을 때를 제외하고는 개인정보를 목적 외의 용도로 이용하거나 이를 제3자에게 제공할 수 있습니다</p>
      <p>가. 제휴회사에 개인신용정보 제공</p>
      <p>(1) 제공업체: (주)스타크레디트대부.(주)밀리언캐쉬대부.(주)유아이크레디트대부.(주)아스리트대부(주)뉴원대부중개,(주)더원대부중개,(주)모네다대부중개,(주)온누리파트너스대부중개,(주)피닉스대부중개,㈜에스엠씨대부중개.(주)오케이앤캐시대부중개</p>
      <p>(2) 대부중개를 위하여 대부중개업자를 거친 경우 그 대부중개업자</p>
      <p>나. 제공받는 신용정보의 내용</p>
      <p>(1) 성명,생년월일,성별,주소,직업,국적,연락처 등의 식별정보 및 대출에 필요한 서류및 정보</p>
      <p>다. 제공받는 자의 이용 목적 및 정보 보유, 이용기간</p>
      <p>(1) 제공목적: 대출접수 및 신청 ,중개수수료 정산</p>
      ...
      <br />
      <br />
      <p>제5조 (개인정보 자동 수집 장치의 설치, 운영 및 거부 관련사항)</p>
      ...
      <p>제8조(개인정보의 파기)</p>
      <p>가. 파기 절차</p>
      <p>이용자가 입력한 정보는 목절 달성 후 별도의 DB에 옮겨져(종이의 경우 별도의 서류) 내부 방침 및 기타관련 법령에 따라 일정기간 저장 후 혹은 즉시 파기됩니다. 이 때, 옮겨진 개인정보는 법령의 규정에 의한 경우를 제외하고는 다른목적으로 이용되지 않습니다.</p>
      <p>나. 파기 기한</p>
      <p>이용자의 개인정보는 보유기간일로부터 즉시파기, 개인정보의 처리 목적 달성, 해당 서비스의 폐지, 사업의 종료 등 그 개인정보가 불필요하게 되었을 때에는 개인정보의 처리가 불필요한 것으로 인정되는 날로부터 즉시 개인정보를 파기합니다.</p>
      <p>다. 파기 방법</p>
      <p>전자적 파일 형태의 정보는 기록을 재생할 수 없는 기술적 방법을 사용합니다. 종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각을 통하여 파기합니다.</p>
      <br />
      <p>제9조(개인정보의 안전성 확보 조치)</p>
      <p>회사는 개인정보보호법 제29조에 따라 다음 각 호와 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.</p>
      <p>가. 개인정보의 암호화</p>
      <p>고객의 비밀번호는 암호화 되어 저장 및 관리되고 있어, 본인만이 알 수 있으며 중요한 데이터는 파일 및 전송 데이터를 암호화 하거나 파일 잠금 기능을 사용하는 등의 별도 보안기능을 사용하고 있습니다.</p>
      <p>나. 해킹 등에 대비한 기술적 대책</p>
      <p>회사는 외부로부터 접근이 통제된 구역에 시스템을 설치하는 등 기술적,물리적으로 감시 및 차단하고 있습니다.</p>
      <p>다. 개인정보처리시스템 접근 제한</p>
      ...
      <br />
      <p>제10조(개인정보 처리방침의 변경)</p>
      <p>회사가 법령 및 방침에 따라 개인정보 처리방침을 변경하는 경우에는 변경 및 시행의 시기, 변경된 내용을 공지사항을 통하여 공개합니다.</p>
      <br />
      <p>제11조 (권익침해 구제방법)</p>
      <p>고객께서 개인정보침해로 인한 신고나 상담이 필요하신 경우 회사의 민원센터 또는 아래 기관에 문의하시기 바랍니다.</p>
      <p>개인정보분쟁조정위원회</p>
      <p>한국인터넷진흥원 개인정보침해신고센터(www.kopico.or.kr / 02-1336)</p>
      ...
      <br />
      <p>제12조 (개인정보 관리책임자)</p>
      <p>개인정보 보호법 제31조 제1항에 따른 회사의 개인정보 보호책임자는 다음과 같습니다.</p>
      <p>가. 개인정보관리책임자</p>
      <p>성명 : 김민주</p>
      <p>직급 : 대표</p>
      <p>전화번호 : 070 7049 0620</p>
      <p>주소 : 서울특별시 강북구 한천로124가길 53, 103호</p>
      <br />
      <p>제13조 (고지)</p>
      <p>현 개인정보 처리방침 내용의 추가, 삭제 및 수정이 있을 시에는 개정 최소 7일전부터 홈페이지의 '공지사항'을 통해 고지할 것입니다.</p>

      <p>○ 본 방침은 2018년 11월 7일부터 시행됩니다.</p>
      <div slot="footer">
        <el-button @click="termDialog=false">확인</el-button>
      </div>
    </el-dialog>
  </div>
</template>
