<template>
  <div>
    <div class="productContainer">
      <ProductTitle title="군미필 대출">
        군대 입대전 생계자금이나 군복무중에 휴가비용 등..생활비가 필요하실때 적당한 상품
      </ProductTitle>
      <ProductExplain title="대상">만19세 이상 군미필이라면 누구나 가능/군복무중에도 가능(이병~)단, 무직이라면 대출 없는 고객에 한해서 가능하며, 기존대출 소액 사용시 4대보험 가입되어있는직장있으면 OK!</ProductExplain>
      <ProductExplain title="한도">~ 500만원 대출가능 (무소득자 제외)</ProductExplain>
      ...
      <ProductExplain title="접수 불가">학자금사용자(단,제적증명서 가능하거나 4대보험 가입되어있는 직장인이면 가능)<br />기존대출 사용자 불가(단,500만원 미만 사용일경우 4대보험가입 되어있는 직장인이면 가능)</ProductExplain>
      <ProductExplain title="구비 서류">주민등록증사본,주민등록초본(최근1주일이내),통장사본,<br />주거래통장 3개월 입출금거래내역,득실확인서(피부양자)</ProductExplain>
