  ...
  <div>
    <div class="productContainer">
      <el-row style="margin-bottom:100px;border:none;">
        ...
        <el-col class="explanation"><span>소득활동을 하면서 생활자금,병원비,각종공과금 납부 등 급하게 자금이 필요한 고객을 위한 상품</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>대상</h3>
        </el-col>
        <el-col :sm="20"><span>만19 ~ 만60세 1개월이상 재직중인 직장인(현금수령 가능)</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>한도</h3>
        </el-col>
        <el-col :sm="20"><span>~ 5000만원 대출가능(신용에 따라 차등 적용) 까지</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>기간</h3>
        </el-col>
        <el-col :sm="20"><span>6개월~최장 5년까지 취급 수수료 없음.</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>금리</h3>
      ...
      <el-row class="rowText marginText">
        ...
        <el-col :sm="20"><span>기본서류 : 주민등록증사본,주민등록초본(최근1주일이내),통장사본<br/>재직서류 : 건강보험자격득실확인서 + 건강보험납부증명서<br/>소득서류 : 급여통장 3개월내역,의료보험납부증명서 또는 원천징수영수증</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>지급 방식</h3>
