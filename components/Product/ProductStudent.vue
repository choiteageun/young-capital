  ...
  <div>
    <div class="productContainer">
      <el-row style="margin-bottom:100px;border:none;">
        ...
        <el-col class="explanation"><span>학업을 하면서 식비,생활비,교통비,학원비 등..생활자금이 필요한 경우에는 대학생대출!</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>대상</h3>
        </el-col>
        <el-col :sm="20"><span>만19 ~ 만35세,전국 대학교 재학생, 학점은행제 사이버대 기능대 가능</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>한도</h3>
        </el-col>
        <el-col :sm="20"><span>~ 2500만원 대출가능 (무소득자 가능)</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>기간</h3>
      ...
      <el-row class="rowText marginText">
        ...
        <el-col :sm="20"><span>주민등록증사본,주민등록초본(최근1주일이내),통장사본,최종학력증명서,<br/>주거래통장 3개월 입출금거래내역</span></el-col>
      </el-row>
      <el-row class="rowText">
        <el-col :sm="4">
          <h3>지급 방식</h3>
