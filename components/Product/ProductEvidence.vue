<template>
  <div>
    <div class="productContainer">
      <ProductTitle title="무설정 담보 대출">
        주택담보대출은 70% 밖에 대출을 받을수없다?주택담보대출이 있어도 시세 최대 100%까지 가능
      </ProductTitle>
      <ProductExplain title="대상">아파트,빌라,연립(다세대) 등 본인명의소유자 (후순위 담보대출가능)<br />
        시세 100% 범위안에서 취급가능,한도:제한없음<br />
        지역:전국(제주,울릉,거제도 가능)</ProductExplain>
      <ProductExplain title="한도">제한없음</ProductExplain>
      ...
      <ProductExplain title="상환 방식">원금 자율분할상환</ProductExplain>
      <ProductExplain title="구비 서류">주민등록증사본,주민등록초본(최근1주일이내),통장사본,등기부등본<br />
        등기필증 ,전입세대 열람확인서,인감증명서</ProductExplain>
